...
_HERMES_BEHAVIORAL_VARS = frozenset({
    ...
    "HERMES_MANAGED",
    "HERMES_MANAGED_DIR",
    # Enterprise employee launch pins.  These are not credentials themselves,
    # but a real launcher setting any of them can activate the strict managed
    # dotenv boundary or point a test at a production employee home/policy.
    "HERMES_MANAGED_EMPLOYEE",
