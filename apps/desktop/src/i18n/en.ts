...
export const en: Translations = {
  ...
  boot: {
    ready: 'My King Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading My King settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote My King backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting My King Desktop…'
    },
    errors: {
      backgroundExited: 'My King background process exited.',
      backgroundExitedDuringStartup: 'My King background process exited during startup.',
      backendStopped: 'Backend stopped',
      desktopBootFailed: 'Desktop boot failed',
      employeeEnrollmentRequired: 'Sign in with your company employee account to connect.',
      gatewayConnectionLost: 'Lost connection to the gateway',
      gatewaySignInRequired: 'Gateway sign-in required',
      ipcBridgeUnavailable: 'Desktop IPC bridge is unavailable.'
    },
    failure: {
      title: "My King couldn't start",
      description:
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your My King backend is older than this desktop build and may not work correctly. Update to align them.',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting My King Desktop.',
    ...
    native: {
      ...
      inputBody: 'My King is waiting for your response.',
      turnDoneTitle: 'My King finished',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to My King defaults?',
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Plugins you installed into the My King backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the My King backend to manage this plugin from Desktop.',
      ...
      installModal: {
        ...
        agentTargetLocal: profile => `Installs into the ${profile} backend (~/.myking/plugins/)`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while My King is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'My King asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while My King was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while My King was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let My King follow your system setting.',
      ...
      backdropDesc: 'The quiet My King glass aura behind the conversation.',
      introSplashTitle: 'Intro Splash',
      introSplashDesc: 'The wordmark and prompt shown on an empty chat.',
      reactionsTitle: 'Message Reactions',
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and My King can react to yours.',
      ...
      themeNoMatches: query => `No installed themes match “${query}”.`,
      themeNames: { nous: 'Classic', 'liquid-glass': 'Liquid Glass' },
      themeDescriptions: {
        nous: 'A calm neutral palette with a My King blue accent.',
        'liquid-glass': 'Layered optical glass in pearl, silver, and Apple blue.'
      },
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what My King is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen My King, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      bundleOutOfSyncDesc:
        'The My King backend is newer than this desktop package. Backend updates never replace your branded interface; install the next verified My King desktop package when you want its new interface features.',
      bundleOutOfSyncAction: 'Open My King updates',
      updates: 'Updates',
      checkNow: 'Check now',
      checking: 'Checking…',
      seeWhatsNew: "See what's new",
      updateNow: 'Update now',
      releaseNotes: 'Update details',
      ...
      automaticUpdatesDesc:
        'My King updates its backend independently. Your branded interface and layout stay unchanged until a verified My King desktop package is installed.',
      ...
      uninstall: {
        ...
        confirmDescription: consequence => `This removes ${consequence}. This cannot be undone.`,
        appPath: path => `App: ${path}`,
        failedStart: 'Uninstall could not start.',
        uninstalling: 'Uninstalling…',
        confirmAction: 'Yes, uninstall',
        cancel: 'Cancel',
        title: 'Uninstall My King',
        description: 'Choose how much to remove. The app closes to finish; reinstall any time to come back.',
        options: {
          gui: {
            title: 'Uninstall desktop app only',
            description: 'Remove this desktop app. The My King agent, configuration, and chats stay.',
            consequence: 'the desktop app and its local app data'
          },
          lite: {
            title: 'Uninstall app and agent, keep my data',
            description: 'Remove the app and agent, but keep configuration, chats, and secrets for a future reinstall.',
            consequence: 'the desktop app and My King agent; configuration, chats, and secrets are kept'
          },
          full: {
            title: 'Uninstall everything',
            description: 'Remove the app, agent, and all My King user data, including chats, jobs, secrets, and logs.',
            consequence: 'the desktop app, My King agent, configuration, chats, secrets, and logs'
          }
        }
      }
    },
    config: {
      ...
      loading: 'Loading My King configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening My King.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every My King gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by My King Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'My King Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The My King runtime managed by this app.',
      kindRemoteDesc: 'A My King gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your My King Cloud account.',
      kindSshDesc: 'A My King install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers My King manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under My King Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      employeeEnrollment: {
        ...
        description:
          'Sign in with your company employee account. Signing in on a new computer replaces the previous connection, and My King never stores your password.',
        emailPlaceholder: 'Employee account',
        passwordPlaceholder: 'Password',
        connect: 'Sign in and connect',
        check: 'Check connection',
        reconnect: 'Reconnect',
        diagnostics: 'View diagnostics',
        connectedTitle: 'My King is connected',
        employee: 'Employee',
        localAccess: 'This device',
        remoteGateway: 'Remote gateway',
        secureConnection: 'Secure connection',
        normal: 'Normal',
        recentCheck: 'Last checked',
        neverChecked: 'Not checked yet',
        recheck: 'Check again',
        reauthorize: 'Authorize again',
        unbind: 'Disconnect this computer',
        unbindTitle: 'Sign out of My King on this computer?',
        unbindDescription: 'My King will remove only its connector, key, and background task from this computer.',
        diagnosticsTitle: 'My King Employee Connector diagnostics',
        diagnosticsEmpty: 'No connector diagnostics have been recorded yet.',
        close: 'Close',
        stages: {
          idle: 'Waiting for employee sign-in',
          'validating-invitation': 'Verifying employee account',
          'confirming-identity': 'Confirming employee identity',
          'configuring-secure-connection': 'Configuring this device’s secure connection',
          'enabling-device-access': 'Enabling employee device access',
          'connecting-remote-gateway': 'Connecting to the My King remote gateway',
          'verifying-isolation': 'Verifying device isolation',
          connected: 'Connected to company agent',
          error: 'Connection needs attention'
        },
        completedStages: {
          'validating-invitation': 'Employee account verified',
          'confirming-identity': 'Employee identity confirmed',
          'configuring-secure-connection': 'This device’s secure connection is configured',
          'enabling-device-access': 'Employee device access enabled',
          'connecting-remote-gateway': 'Connected to the My King remote gateway',
          'verifying-isolation': 'Device isolation verified'
        },
        pendingStages: {
          'validating-invitation': 'Verify employee account',
          'confirming-identity': 'Confirm employee identity',
          'configuring-secure-connection': 'Configure this device’s secure connection',
          'enabling-device-access': 'Enable employee device access',
          'connecting-remote-gateway': 'Connect to the My King remote gateway',
          'verifying-isolation': 'Verify device isolation'
        },
        errors: {
          'invite-expired': 'The invitation has expired. Ask your administrator to generate a new one.',
          'invite-used': 'The invitation has already been used by another device.',
          'permission-required': 'This device needs system permission. Click Authorize again.',
          'device-already-bound':
            'This computer is connected to another employee account. Disconnect it before signing in.',
          'employee-mismatch': 'The employee identity does not match, so connection stopped.',
          'isolation-failed': 'Device isolation verification failed, so connection stopped.',
          'central-host-blocked':
            'This computer is the company control host and cannot be used as an employee device. Sign in on the employee computer.',
          ...
          'invalid-credentials': 'The employee account or password is incorrect.',
          'employee-agent-unavailable':
            'This employee account has no running My King assigned. Contact your administrator.',
          'employee-agent-ambiguous':
            'This employee account has more than one running My King assigned. Contact your administrator.',
          ...
          'invalid-invitation': 'This employee account connection request is invalid. Sign in again.',
          'not-bound': 'This device is not connected yet.',
          'connector-failed': 'The secure connection could not start. Try again.'
        }
      },
      ...
      remoteDesc: 'Connect this desktop shell to a remote My King backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'My King Cloud',
      cloudDesc: 'Sign in once to My King Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'My King Cloud',
      cloudSignIn: 'Sign in to My King Cloud',
      cloudSignedIn: 'Signed in to My King Cloud',
      cloudNeedsSignIn: 'Sign in to My King Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your My King Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'My King Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of My King Cloud',
      cloudSignedOutMessage: 'Cleared the My King Cloud session.',
      ...
      restartingMessage: 'My King Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · My King ${version}` : ''}`,
      ...
      sshDesc:
        'My King is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — My King found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — My King runs ssh non-interactively.',
      sshErrHostKey:
      ...
      sshErrUpdateRequired: 'Update My King on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to My King. Review the exact configuration below — it comes from the link, not from My King.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. My King runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      providerDescriptions: {
        nousPortal: 'Hosted My King & Nous-trained models',
        fireworks: 'OpenAI-compatible direct model API',
        openrouter: 'Aggregator for hundreds of frontier models',
        anthropic: 'Claude API access (Sonnet, Opus, Haiku)',
        xai: 'Grok models (use OAuth for SuperGrok / Premium+)',
        gemini: 'Google AI Studio (Gemini 1.5 / 2.0 / 2.5)',
        deepseek: 'Direct DeepSeek API (V3.x, R1)',
        dashscope: 'Alibaba Cloud DashScope — Qwen and multi-vendor models',
        glm: 'Zhipu GLM-4.6 and Z.AI hosted endpoints',
        kimi: 'Moonshot Kimi K2 / coding endpoints',
        kimiChina: 'Moonshot China endpoint',
        minimax: 'MiniMax-M2 and Hailuo international endpoints',
        minimaxChina: 'MiniMax mainland China endpoint',
        huggingFace: 'Inference Providers — 20+ open models via router.huggingface.co',
        openCodeZen: 'Pay-as-you-go access to curated coding models',
        openCodeGo: '$10/month subscription for open coding models',
        nvidia: 'build.nvidia.com or your own local NIM endpoint',
        ollama: 'Cloud-hosted open models from ollama.com',
        lmStudio: 'Local LM Studio server (OpenAI-compatible)',
        stepFun: 'StepFun Step Plan coding models',
        xiaomiMiMo: 'MiMo-V2.5 and Xiaomi proprietary models',
        arceeAi: 'Arcee-hosted small + medium models',
        gmiCloud: 'GMI Cloud GPU + model serving',
        azureFoundry: 'Azure AI Foundry custom endpoints (OpenAI / Anthropic-compatible)',
        awsBedrock: 'Authenticate via AWS profile + region'
      },
      localEndpoint: {
        title: 'Local / custom endpoint',
        description: 'Point My King at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
      customEndpoints: {
  ...
  starmap: {
    ...
    emptyDesc: 'As My King builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart My King to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update My King to generate pets.',
      backgroundHint: 'You can close this — My King will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure My King desktop' },
  ...
  messaging: {
    ...
    platformSummary: name => `Use My King through ${name}.`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent My King environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'My King did not save that model change.'
    },
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. My King will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the My King backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from My King. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the My King backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting My King...',
    placeholderReconnecting: 'Reconnecting to My King…',
    ...
    wakeWordListening: () => 'Wake word — listening',
    wakeWordOff: () => 'Wake word — off',
    wakeWordPausedVoice: () => 'Wake word — paused during voice chat',
    ...
    attachUrlDesc: 'My King will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask My King to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating My King…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting My King…',
    ...
    unsupportedMessage: 'This version of My King can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of My King is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected My King backend is ready to install.',
    ...
    applyingBody:
      'The My King updater takes over in its own window and reopens My King automatically when it’s done. Please don’t reopen My King yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. My King reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then My King reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update My King?',
    blockerBody:
      'My King needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update My King',
    foreignBlockerBody:
      'My King can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'My King can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    oneTimeTitle: 'My King needs a one-time install',
    ...
    setupChoiceTitle: 'Set up My King Desktop',
    setupChoiceDesc:
      'Connect this app to a My King gateway you already run, or install My King locally on this computer.',
    connectExistingTitle: 'Connect to existing My King',
    ...
    installLocalTitle: 'Install My King locally',
    installLocalDesc: 'Download My King, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart My King Desktop and try again.',
    remoteSetupTitle: 'Connect to existing My King',
    ...
    settingUpTitle: 'Setting up My King Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another My King CLI or desktop instance is running. Stop any running My King instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The My King installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with My King Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'My King is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting My King…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run My King',
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — My King connects automatically',
    ...
    authorizeThere: 'Authorize My King there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize My King there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. My King will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'My King is restarting...',
      askRestart: 'Ask My King to restart the server',
      lookingRestart: taskId => `My King is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'My King is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask My King to open a page.',
      finishedRestarting: message => `My King finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'My King could not restart the server.',
      stillWorking:
        'My King is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'My King is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'My King gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.myking/config.yaml). My King won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'My King needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'My King needs a credential to continue.',
  ...
  desktop: {
    ...
    fileStillSaving: 'The file is still being written. Wait for it to finish saving, then retry.',
    ...
    restartToUseSaveImage: 'Restart My King Desktop to use Save Image.',
    restartToSaveImages: 'Restart My King Desktop to save images',
