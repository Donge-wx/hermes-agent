...
export const en: Translations = {
  ...
  settings: {
    ...
    about: {
      ...
      bundleOutOfSyncDesc:
        'The My King runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      ...
      automaticUpdatesDesc:
        'My King checks for updates automatically in the background and lets you know when one is ready.',
