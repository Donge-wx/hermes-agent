    ...
    gateway: {
      employeeEnrollment: {
        ...
        errors: {
          ...
          'device-already-bound': '当前设备已绑定其他员工，已拒绝覆盖。',
          ...
          'invalid-invitation': '请输入有效的一次性绑定码。',
