  ...
  settings: {
    ...
    gateway: {
      employeeEnrollment: {
        ...
        reauthorize: '再認証',
        unbind: 'バインド解除',
        unbindTitle: 'この従業員デバイスのバインドを解除しますか？',
        unbindDescription: 'My King が作成した接続コンポーネント、鍵、バックグラウンドタスクだけを削除します。',
        diagnosticsTitle: 'My King Employee Connector の診断',
        diagnosticsEmpty: '接続コンポーネントの診断記録はまだありません。',
        close: '閉じる',
        stages: {
          idle: '招待を待機中',
          'validating-invitation': '招待を検証中',
        ...
        completedStages: {
          'validating-invitation': '招待を検証しました',
        ...
        errors: {
          ...
          'device-already-bound': 'このデバイスは別の従業員にバインド済みのため、上書きを拒否しました。',
          ...
          'invalid-invitation': '有効な 1 回限りの登録コードを入力してください。',
