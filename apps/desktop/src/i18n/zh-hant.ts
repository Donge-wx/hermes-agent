    ...
    gateway: {
      employeeEnrollment: {
        ...
        errors: {
          ...
          'device-already-bound': '目前裝置已綁定其他員工，已拒絕覆寫。',
          ...
          'invalid-invitation': '請輸入有效的一次性綁定碼。',
