...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    about: {
      ...
      bundleOutOfSyncDesc:
        'My King 執行環境已更新,但桌面應用程式本身仍是舊建置——在應用程式更新之前,新的介面功能(如 Bot Mode)不會顯示。請執行下方的更新以重新建置應用程式。如果此警告仍未消除,請從最新的桌面安裝程式重新安裝。',
      ...
      automaticUpdatesDesc: 'My King 會在背景自動檢查更新，並在有可用更新時通知你。',
