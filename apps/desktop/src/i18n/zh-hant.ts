...
export const zhHant = defineLocale({
  ...
  boot: {
    ready: 'My King Desktop 已就緒',
    desktopBootFailedWithMessage: message => `桌面啟動失敗：${message}`,
    steps: {
      connectingGateway: '正在連線桌面閘道',
      loadingSettings: '正在載入 My King 設定',
      loadingSessions: '正在載入最近工作階段',
      retryingRemoteBackend: '正在重新連線遠端 My King 後端…',
      startingDesktopConnection: '正在啟動桌面連線',
      startingHermesDesktop: '正在啟動 My King Desktop…'
    },
    errors: {
      backgroundExited: 'My King 背景程序已結束。',
      backgroundExitedDuringStartup: 'My King 背景程序在啟動期間結束。',
      backendStopped: '後端已停止',
      desktopBootFailed: '桌面啟動失敗',
      employeeEnrollmentRequired: '請先使用公司員工帳號登入並連線。',
  ...
  notifications: {
    ...
    backendOutOfDateMessage: '您的 My King 後端早於目前的桌面版本，可能無法正常運作。請更新以保持一致。',
    ...
    errors: {
      ...
      methodNotAllowed: '桌面後端拒絕了該請求 (405 Method Not Allowed)。請嘗試重新啟動 My King Desktop。',
  ...
  settings: {
    ...
    resetConfirm: '要將所有設定恢復為 My King 預設值嗎？',
    exportFailed: '匯出失敗',
    resetFailed: '重設失敗',
    nav: {
      providers: '提供方',
    ...
    notifications: {
      ...
      focusedHint: '完成提醒僅在 My King 位於背景時觸發。',
      kinds: {
        approval: {
          label: '需要核准',
        ...
        input: {
          label: '需要輸入',
          description: 'My King 提出了問題，或需要密碼或密鑰。'
        },
        turnDone: {
          label: '回覆就緒',
          description: 'My King 在背景時完成了一輪對話。'
        },
        turnError: {
          label: '本輪失敗',
          description: '背景回合錯誤。'
        ...
        plugin: {
          label: '外掛通知',
          description: 'My King 在背景時，桌面外掛傳送了通知。'
        }
      },
      test: '傳送測試通知',
      testTitle: 'My King',
    ...
    appearance: {
      ...
      colorMode: '色彩模式',
      colorModeDesc: '選擇固定模式，或讓 My King 跟隨系統設定。',
      ...
      backdropTitle: '聊天背景',
      backdropDesc: '對話後方低調呈現的 My King 玻璃光暈。',
      introSplashTitle: '開場標識',
      introSplashDesc: '空白對話中顯示的字標和提示語。',
      reactionsTitle: '訊息回應',
      reactionsDesc: 'iMessage 風格的表情回應 — 你可以對訊息做出回應，My King 也能回應你的訊息。',
      ...
      removeTheme: '移除主題',
      importedBadge: '已匯入',
      themeSearchPlaceholder: '搜尋已安裝主題或 VS Code Marketplace…',
      themeNoMatches: query => `沒有已安裝主題符合「${query}」。`,
      themeNames: { nous: '經典', 'liquid-glass': '液態玻璃' },
      themeDescriptions: {
        nous: '沉靜的中性色調與 My King 藍色強調色。',
        'liquid-glass': '珍珠、銀色與 Apple 藍構成的分層光學玻璃。'
      },
      pet: {
        title: '寵物',
        intro:
          '領養一隻懸浮在應用上的 petdex 動畫寵物，它會根據 My King 的狀態做出反應——工具執行時奔跑、成功時歡呼、出錯時沮喪。',
        restartHint: '寵物功能需要重新啟動——目前執行的應用在此功能加入前啟動。請結束並重新開啟 My King，然後回到此處。',
        scaleTitle: '大小',
    ...
    fieldDescriptions: defineFieldCopy({
      ...
      timezone: 'My King 需要本機時間上下文時使用。留空則使用系統時區。',
      agent: {
        imageInputMode: '控制圖片附件如何傳送給模型。',
        maxTurns: 'My King 停止一次執行前的工具呼叫輪次上限。'
      },
      terminal: {
      ...
      fileReadMaxChars: 'My King 單次檔案讀取可讀取的最大字元數。',
      approvals: {
        mode: 'My King 如何處理需要明確批准的指令。',
      ...
      updates: {
        nonInteractiveLocalChanges:
          'My King 從應用程式內更新自身時，保留本機原始碼變更（stash）或丟棄（discard）。終端機更新一律會詢問。'
      }
    }),
    about: {
      ...
      bundleOutOfSyncDesc:
        'My King 後端比目前桌面安裝包更新。後端更新絕不會替換品牌介面；需要新的介面功能時，請安裝下一版通過驗證的 My King 桌面安裝包。',
      bundleOutOfSyncAction: '開啟 My King 更新',
      updates: '更新',
      checkNow: '立即檢查',
      checking: '檢查中…',
      seeWhatsNew: '查看新增內容',
      ...
      automaticUpdatesDesc:
        'My King 會獨立更新後端；品牌介面與現有佈局保持不變，只有通過驗證的 My King 桌面安裝包才會更新前端。',
      ...
      uninstall: {
        ...
        checking: '正在檢查已安裝內容…',
        confirmTitle: '確認解除安裝',
        confirmDescription: consequence => `這將移除${consequence}，且無法復原。`,
        appPath: path => `應用程式：${path}`,
        failedStart: '無法啟動解除安裝程式。',
        uninstalling: '正在解除安裝…',
        confirmAction: '確認解除安裝',
        cancel: '取消',
        title: '解除安裝 My King',
        description: '請選擇移除範圍。應用程式會關閉以完成操作；之後可隨時重新安裝。',
        options: {
          gui: {
            title: '僅移除桌面應用程式',
            description: '保留 My King 智慧體、設定與聊天記錄。',
            consequence: '桌面應用程式及其本機資料'
          },
          lite: {
            title: '移除應用程式和智慧體，保留資料',
            description: '保留設定、聊天記錄與密鑰，方便日後重新安裝。',
            consequence: '桌面應用程式與 My King 智慧體；設定、聊天記錄和密鑰會保留'
          },
          full: {
            title: '全部移除',
            description: '移除應用程式、智慧體與所有 My King 使用者資料。',
            consequence: '桌面應用程式、My King 智慧體、設定、聊天記錄、密鑰與日誌'
          }
        }
      }
    },
    ...
    quickEntry: {
      enabledTitle: '快速輸入',
      enabledDesc: '用全域快速鍵在任何地方喚出一個小輸入框，無需開啟 My King 即可送出提示。',
    ...
    gateway: {
      employeeEnrollment: {
        title: '連線 AI Work OS',
        description:
          '使用公司員工帳號和密碼登入。新電腦登入後會取代舊電腦的連線，My King 不\u2060會\u2060儲\u2060存你的密碼。',
        emailPlaceholder: '員工帳號',
        ...
        reauthorize: '重新授權',
        unbind: '中斷本機連線',
        unbindTitle: '要在這台電腦登出 My King 嗎？',
        unbindDescription:
          'My King 只會刪除這台電腦上的連線元件、金鑰與背景工作，不\u2060會\u2060刪\u2060除你的 SSH 設定或其他金鑰。',
        diagnosticsTitle: 'My King Employee Connector 診斷',
        diagnosticsEmpty: '目前沒有連線元件診斷記錄。',
        close: '關閉',
        stages: {
          idle: '等待員工登入',
          'validating-invitation': '正在驗證員工帳號',
          'confirming-identity': '正在確認員工身分',
          'configuring-secure-connection': '正在設定本機安全連線',
          'enabling-device-access': '正在啟用員工電腦存取',
          'connecting-remote-gateway': '正在連線 My King 遠端閘道',
          'verifying-isolation': '正在驗證裝置隔離',
          connected: '已連線公司智能體',
          error: '連線需要處理'
        },
        completedStages: {
          'validating-invitation': '員工帳號驗證完成',
          'confirming-identity': '員工身分已確認',
          'configuring-secure-connection': '本機安全連線已設定',
          'enabling-device-access': '員工電腦存取已啟用',
          'connecting-remote-gateway': 'My King 遠端閘道已連線',
          'verifying-isolation': '裝置隔離已驗證'
        },
        pendingStages: {
          'validating-invitation': '驗證員工帳號',
          'confirming-identity': '確認員工身分',
          'configuring-secure-connection': '設定本機安全連線',
          'enabling-device-access': '啟用員工電腦存取',
          'connecting-remote-gateway': '連線 My King 遠端閘道',
          'verifying-isolation': '驗證裝置隔離'
        },
        errors: {
          'invite-expired': '邀請已失效，請聯絡管理員重新產生。',
          'invite-used': '邀請已被其他電腦使用。',
          'permission-required': '目前電腦缺少系統權限，請按下「重新授權」。',
          'device-already-bound': '目前電腦已連線其他員工帳號。請先中斷本機連線，再使用你的帳號登入。',
          'employee-mismatch': '員工身分不相符，已停止連線。',
          'isolation-failed': '裝置隔離驗證失敗，已停止連線。',
          'central-host-blocked': '這台電腦是公司總控機，安全策略禁止將它作為員工電腦接入。請在員工電腦上登入。',
          'ssh-service-failed': 'SSH 服務啟動失敗，請檢視診斷資訊。',
          ...
          'invalid-credentials': '員工帳號或密碼不正確。',
          'employee-agent-unavailable': '此員工帳號尚未分配正在執行的 My King，請聯絡管理員。',
          'employee-agent-ambiguous': '此員工帳號關聯了多個正在執行的 My King，請聯絡管理員處理。',
          'not-ready': '公司尚未確認裝置就緒，請稍後重試。',
          'enrollment-failed': '公司拒絕本次接入，請聯絡管理員。',
          'invalid-invitation': '本次員工帳號連線要求無效，請重新登入。',
          'not-bound': '目前電腦尚未連線公司智能體。',
          'connector-failed': '安全連線啟動失敗，請重新連線。'
        }
      },
      loading: '正在載入閘道設定...',
      ...
      savedTitle: '閘道設定已儲存',
      restartingMessage: 'My King Desktop 將使用已儲存的設定重新連線。',
      savedMessage: '已儲存，下次重新啟動後生效。',
      connectedTo: (baseUrl, version) => `已連線至 ${baseUrl}${version ? ` · My King ${version}` : ''}`,
      ...
      sshTitle: '透過 SSH 連線',
      sshDesc:
        'My King 會透過 SSH 在遠端啟動並以通道連線到本應用程式——無需自行啟動或公開任何服務。前提：已具備到該主機的金鑰 SSH 存取。',
      ...
      sshReachable: (host, platform) => `可連線：${host}（${platform}）——已找到 My King`,
    ...
    mcp: {
      ...
      deepLinkDescription:
        '一個連結要求將此 MCP 伺服器加入 My King。請檢查下方的完整設定——它來自該連結，而非 My King。',
    ...
    providers: {
      ...
      intro: '使用訂閱登入，無需複製 API 金鑰。My King 會在應用程式中為您完成瀏覽器登入。',
      connected: '已連線',
      collapse: '收合',
      ...
      providerDescriptions: {
        nousPortal: '託管 My King 與 Nous 訓練的模型',
        fireworks: '相容 OpenAI 的直連模型 API',
        openrouter: '聚合數百個前沿模型',
        anthropic: 'Claude API 存取（Sonnet、Opus、Haiku）',
        xai: 'Grok 模型（SuperGrok / Premium+ 請使用 OAuth）',
        gemini: 'Google AI Studio（Gemini 1.5 / 2.0 / 2.5）',
        deepseek: '直連 DeepSeek API（V3.x、R1）',
        dashscope: '阿里雲 DashScope — Qwen 與多廠商模型',
        glm: '智譜 GLM-4.6 與 Z.AI 託管端點',
        kimi: 'Moonshot Kimi K2 / 程式設計端點',
        kimiChina: 'Moonshot 中國端點',
        minimax: 'MiniMax-M2 與 Hailuo 國際端點',
        minimaxChina: 'MiniMax 中國大陸端點',
        huggingFace: 'Inference Providers — 透過 router.huggingface.co 提供 20+ 個開源模型',
        openCodeZen: '按量付費存取精選程式設計模型',
        openCodeGo: '$10/月訂閱，使用開放程式設計模型',
        nvidia: 'build.nvidia.com 或您自己的本機 NIM 端點',
        ollama: '來自 ollama.com 的雲端開源模型',
        lmStudio: '本機 LM Studio 伺服器（相容 OpenAI）',
        stepFun: 'StepFun Step Plan 程式設計模型',
        xiaomiMiMo: 'MiMo-V2.5 與 Xiaomi 專有模型',
        arceeAi: 'Arcee 託管的小型與中型模型',
        gmiCloud: 'GMI Cloud GPU 與模型服務',
        azureFoundry: 'Azure AI Foundry 自訂端點（相容 OpenAI / Anthropic）',
        awsBedrock: '透過 AWS 設定檔與區域進行驗證'
      },
      localEndpoint: {
        title: '本地 / 自訂端點',
        description: '將 My King 指向任意 OpenAI 相容端點（Zyphra、vLLM、llama.cpp、Ollama 等）。'
      },
      customEndpoints: {
        title: '自訂端點',
        active: '使用中',
        ...
        deleteEndpoint: '刪除端點',
        emptyTitle: '沒有自訂端點',
        emptyDescription: '請在下方新增 OpenAI 相容端點。',
        editTitle: '編輯端點',
        addTitle: '新增端點',
        name: '名稱',
        providerId: '提供方 ID',
  ...
  starmap: {
    ...
    loading: '載入中…',
    emptyTitle: '尚無學習內容',
    emptyDesc: '當 My King 為你的工作建立技能與記憶時，會顯示在這裡。'
  },
  agents: {
    close: '關閉代理',
    title: '派生樹',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: '請重新啟動 My King 以使用寵物功能。',
      empty: '沒有符合的寵物。',
      turnOff: '關閉',
      turnOn: '開啟',
      installed: '已安裝',
    ...
    generatePet: {
      ...
      staleBackend: '請更新 My King 以生成寵物。',
      backgroundHint: '你可以關閉此視窗——完成後 My King 會通知你。',
    ...
    nav: {
      ...
      settings: { title: '設定', detail: '設定 My King 桌面端' },
  ...
  messaging: {
    search: '搜尋訊息平台…',
    platformSummary: name => `透過 ${name} 與 My King 對話並管理連線。`,
    loading: '正在載入訊息平台…',
    loadFailed: '訊息平台載入失敗',
    states: {
      connected: '已連線',
  ...
  profiles: {
    ...
    deleting: '刪除中…',
    createDesc: '設定檔是獨立的 My King 環境：各自擁有獨立的設定、技能和 SOUL.md。',
    nameLabel: '名稱',
    cloneFrom: '複製來源',
    cloneFromNone: '無（空白）',
  ...
  cron: {
    ...
    newCron: '新排程工作',
    emptyDescNew: '按 cron 表達式排程一個提示詞。My King 會執行它，並將結果傳送至您選擇的目的地。',
  ...
  sidebar: {
    ...
    shiftClickHint: 'Shift + 點擊聊天以釘\u2060選 · 拖曳以重\u2060新\u2060排\u2060序',
    noWorkspace: '無工作區',
    projectEmpty: '尚無工作階段',
    noSessions: '尚無工作階段',
    ...
    projects: {
      ...
      createFailed: '無法建立專案',
      staleBackend: '請更新 My King 後端以建立專案——目前後端比桌面應用舊（設定 → 更新 → 後端）。',
      deleteConfirm: '這會從 My King 中移除已儲存的專案。檔案、git 儲存庫和工作樹維持不變。',
      startWork: '新增工作樹',
      ...
      worktreeStaleBackend: '請更新 My King 後端以在此遠端連線上建立工作樹 —— 該後端早於 git 工作樹 API。',
  ...
  composer: {
    intro: {
      headline: '你的工作空間，一句話即可開始。',
      body: '搜尋專案、編輯檔案、執行測試、推進任務。告訴我目標，其餘交給 My King。'
    },
    message: '訊息',
    wakingProfile: profile => `正在喚醒 ${profile}…`,
    placeholderStarting: '正在啟動 My King...',
    placeholderReconnecting: '正在重新連線至 My King…',
    ...
    wakeWordListening: () => '喚醒詞 — 正在聆聽',
    wakeWordOff: () => '喚醒詞 — 已關閉',
    wakeWordPausedVoice: () => '喚醒詞 — 語音對話期間暫停',
    lookupLoading: '查詢中…',
    ...
    attachUrlDesc: 'My King 將擷取該頁面並作為此回合的脈絡。',
    ...
    uploadComplete: '已上傳',
    uploadProgress: percent => `上傳中 ${percent}%`,
    dictating: '聽寫中',
  ...
  updates: {
    ...
    applyingBody:
      'My King 更新程式會在自己的視窗中接管，並在完成後自動重新開啟 My King。更新期間請勿自行重新開啟 My King。',
    applyingBodyBackend: '遠端後端正在套用更新並將重新啟動。恢復後 My King 會自動重新連線。',
    applyingClose: '此視窗會在更新期間關閉，隨後 My King 會自動重新開啟。',
    errorTitle: '更新未完成',
    errorBody: '沒有資料遺失。您可以現在重試。',
    blockerTitle: '關閉本機預覽以更新 My King？',
    blockerBody: 'My King 需要在更新前停止這些本機預覽。這不會修改或刪除您的檔案。',
    foreignBlockerTitle: '關閉其他處理程序以更新 My King',
    foreignBlockerBody:
      'My King 無法安全地自動關閉這些處理程序。請關閉擁有這些處理程序的應用程式、終端機或服務，然後重試更新。',
    mixedBlockerBody: 'My King 可以關閉下方列出的本機預覽。其他處理程序必須手動關閉，更新才能繼續。',
  ...
  install: {
    ...
    setupChoiceTitle: '設定 My King Desktop',
    setupChoiceDesc: '將此應用程式連線到您已執行的 My King 閘道，或在這台電腦上本機安裝 My King。',
    connectExistingTitle: '連線到現有 My King',
    connectExistingShort: '連線現有環境',
    connectExistingDesc: '使用工作階段權杖或瀏覽器登入連線遠端後端。不會啟動本機安裝。',
    installLocalTitle: '本機安裝 My King',
    installLocalDesc: '下載 My King、建立 Python 環境，並在這台電腦上執行後端。',
    localStartUnavailable: '無法啟動本機安裝。請重新啟動 My King Desktop 後再試一次。',
    remoteSetupTitle: '連線到現有 My King',
    ...
    backToSetup: '返回',
    failedTitle: '安裝失敗',
    settingUpTitle: '正在設定 My King Agent',
    finishingTitle: '正在收尾',
    failedDesc:
      '某個安裝步驟失敗。在 Windows 上，如果另一個 My King CLI 或桌面執行個體正在執行，可能會出現這種情況。請停止正在執行的 My King 執行個體後重試。可查看下方的詳細資訊或 desktop 記錄中的完整記錄。',
    activeDesc: '這是一次性設定。My King 安裝程式正在下載相依套件並設定您的電腦。之後啟動會略過此步驟。',
  ...
  onboarding: {
    headerTitle: '開始設定 My King Agent',
    headerDesc: '連線模型提供方即可開始聊天。大多數選項只需一次點擊。',
    preparingInstall: 'My King 正在完成安裝。首次執行通常不到一分鐘。',
    starting: '正在啟動 My King…',
    ...
    recommended: '建議',
    connected: '已連線',
    featuredPitch: '一個訂閱，300+ 前沿模型 — 執行 My King 的建議方式',
    ...
    flowSubtitles: {
      ...
      device_code: '在瀏覽器中開啟驗證頁面 — My King 會自動連線',
    ...
    authorizeThere: '請在那裡授權 My King。',
    copyAuthCode: '複製授權碼並貼到下方。',
    pasteAuthCode: '貼上授權碼',
    reopenAuthPage: '重新開啟授權頁面',
    autoBrowser: provider => `已在瀏覽器中開啟 ${provider}。請在那裡授權 My King，連線會自動完成，無需複製或貼上。`,
  ...
  preview: {
    ...
    largeTitle: '此檔案較大',
    largeBody: (label, size) => `${label} 大小為 ${size}。My King 只會顯示前 512 KB。`,
    previewAnyway: '仍然預覽',
    ...
    web: {
      ...
      failedToLoad: '預覽載入失敗',
      tryAgain: '重試',
      restarting: 'My King 正在重新啟動...',
      askRestart: '請 My King 重新啟動伺服器',
      lookingRestart: taskId => `My King 正在尋找要重新啟動的預覽伺服器 (${taskId})`,
      restartingTitle: '正在重新啟動預覽伺服器',
      restartingMessage: 'My King 正在背景執行。可在預覽主控台查看進度。',
      ...
      blankPageBody: '在上方輸入網址開始瀏覽，或請 My King 開啟頁面。',
      finishedRestarting: message => `My King 已完成預覽伺服器重新啟動${message ? `：${message}` : ''}`,
      failedRestarting: message => `伺服器重新啟動失敗：${message}`,
      unknownError: '未知錯誤',
      restartedTitle: '預覽伺服器已重新啟動',
      reloadingNow: '正在重新載入預覽。',
      restartFailedTitle: '預覽重新啟動失敗',
      restartFailedMessage: 'My King 無法重新啟動伺服器。',
      stillWorking: 'My King 仍在執行，但尚未收到重新啟動結果。伺服器指令可能正在前台執行。',
  ...
  assistant: {
    thread: {
      ...
      showEarlier: '顯示較早的訊息',
      loadingResponse: 'My King 正在載入回覆',
    ...
    approval: {
      gatewayDisconnected: 'My King 閘道未連線',
      sendFailed: '無法傳送核准回應',
      run: '執行',
      command: '指令',
      moreOptions: '更多核准選項',
      ...
      alwaysDescription: pattern =>
        `這會將「${pattern}」模式加入永久允許清單（~/.myking/config.yaml）。My King 對類似指令將不再詢問，包括目前工作階段和未來工作階段。`,
      alwaysAllow: '一律允許'
    },
    clarify: {
      notReady: '澄清請求尚未就緒',
  ...
  prompts: {
    ...
    sudoTitle: '管理員密碼',
    sudoDesc: 'My King 需要您的 sudo 密碼來執行特權指令。它只會傳送給您的本機代理。',
    sudoPlaceholder: 'sudo 密碼',
    secretTitle: '需要密鑰',
    secretDesc: 'My King 需要一個憑證才能繼續。',
  ...
  desktop: {
    ...
    fileStillSaving: '檔案仍在寫入，請等待儲存完成後重試。',
    ...
    restartToUseSaveImage: '重新啟動 My King Desktop 後可使用儲存圖片。',
    restartToSaveImages: '重新啟動 My King Desktop 以儲存圖片',
