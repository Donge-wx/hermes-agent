...
export const ar = defineLocale({
  sendDiagnostics: {
    ...
    failedHint: 'يمكنك أيضاً فتح السجلات المحلية من الإعدادات ← البوابة، ثم إرفاق تفاصيل التشخيص بمحادثة الدعم.',
  ...
  boot: {
    ready: 'My King Desktop جاهز',
    desktopBootFailedWithMessage: message => `فشل تشغيل سطح المكتب: ${message}`,
    steps: {
      connectingGateway: 'جار الاتصال ببوابة سطح المكتب',
      loadingSettings: 'جار تحميل إعدادات My King',
      loadingSessions: 'جار تحميل الجلسات الأخيرة',
      retryingRemoteBackend: 'جارٍ إعادة الاتصال بخادم My King البعيد…',
      startingDesktopConnection: 'جار بدء اتصال سطح المكتب',
      startingHermesDesktop: 'جار تشغيل My King Desktop...'
    },
    errors: {
      backgroundExited: 'خرجت عملية My King الخلفية.',
      backgroundExitedDuringStartup: 'خرجت عملية My King الخلفية أثناء بدء التشغيل.',
      backendStopped: 'توقف الخلفية',
      desktopBootFailed: 'فشل تشغيل سطح المكتب',
      employeeEnrollmentRequired: 'سجّل الدخول بحساب الموظف في الشركة للاتصال.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage: 'خلفية My King أقدم من إصدار سطح المكتب الحالي وقد لا تعمل كما يجب. حدثهما ليتوافقا.',
    updateHermes: 'تحديث My King',
    ...
    errors: {
      ...
      methodNotAllowed: 'رفضت خلفية سطح المكتب هذا الطلب (405 Method Not Allowed). جرب إعادة تشغيل My King Desktop.',
    ...
    native: {
      ...
      inputBody: 'ينتظر My King ردّك.',
      turnDoneTitle: 'أنهى My King',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'هل تريد إعادة كل الإعدادات إلى افتراضيات My King؟',
    ...
    plugins: {
      ...
      blurb:
        'امتدادات واجهة تُحمّل داخل هذا التطبيق — إما مضمّنة مع البناء، أو موضوعة في مجلد desktop-plugins (بما فيها التي يكتبها My King). تعطيل الإضافة يفرغها مباشرة ويبقى بعد إعادة التشغيل.',
      count: n => `${n} مثبتة`,
    ...
    notifications: {
      ...
      focusedHint: 'تنبيهات الاكتمال تظهر فقط عندما يكون My King في الخلفية.',
      kinds: {
        approval: {
          label: 'يلزم الموافقة',
        ...
        input: {
          label: 'يلزم إدخال',
          description: 'طرح My King سؤالا أو يحتاج إلى كلمة مرور أو سر.'
        },
        turnDone: {
          label: 'الرد جاهز',
          description: 'انتهى دور بينما كان My King في الخلفية.'
        },
        turnError: {
          label: 'فشل الدور',
    ...
    appearance: {
      title: 'المظهر',
      intro: 'خصص مظهر My King Desktop.',
      ...
      backdropDesc: 'هالة My King الزجاجية الهادئة خلف المحادثة.',
      ...
      reactionsDesc: 'تفاعلات إيموجي بأسلوب iMessage — تفاعل مع الرسائل، ويمكن لـ My King التفاعل مع رسائلك.',
      ...
      themeSearchPlaceholder: 'ابحث في السمات أو VS Code Marketplace…',
      themeNoMatches: query => `لا توجد سمة مثبتة تطابق «${query}».`,
      themeNames: { nous: 'كلاسيكي', 'liquid-glass': 'الزجاج السائل' },
      themeDescriptions: {
        nous: 'ألوان محايدة هادئة مع لمسة My King الزرقاء.',
        'liquid-glass': 'زجاج بصري متعدد الطبقات باللؤلؤ والفضي وأزرق Apple.'
      },
      pet: {
        title: 'حيوان أليف',
        intro:
          'تبنَّ تعويذة petdex متحركة تطفو فوق التطبيق وتتفاعل مع ما يفعله My King — تجري أثناء تنفيذ الأدوات، وتحتفل عند النجاح، وتعبس عند الأخطاء.',
        restartHint:
          'تحتاج الحيوانات الأليفة إلى إعادة تشغيل سريعة — بدأ التطبيق العامل قبل إضافة هذه الميزة. أغلق My King وأعد فتحه، ثم ارجع إلى هنا.',
        on: 'تشغيل',
        off: 'إيقاف',
        scaleTitle: 'الحجم',
    ...
    fieldDescriptions: {
      ...
      timezone: 'تستخدم عندما يحتاج My King إلى سياق الوقت المحلي. اتركها فارغة لاستخدام منطقة النظام.',
      'agent.imageInputMode': 'يتحكم في طريقة إرسال مرفقات الصور إلى النموذج.',
      'agent.maxTurns': 'الحد الأعلى لدورات استدعاء الأدوات قبل أن يوقف My King التشغيل.',
      ...
      fileReadMaxChars: 'أقصى عدد أحرف يستطيع My King قراءته من ملف واحد في الطلب.',
      'approvals.mode': 'كيف يتعامل My King مع الأوامر التي تحتاج موافقة صريحة.',
      ...
      'updates.nonInteractiveLocalChanges':
        'عندما يحدّث My King نفسه من التطبيق دون موجه طرفية، احتفظ بتعديلات المصدر المحلية أو تجاهلها.'
    },
    about: {
      heading: 'حول My King',
      ...
      bundleOutOfSyncDesc:
        'الواجهة الخلفية في My King أحدث من حزمة سطح المكتب الحالية. لا تستبدل تحديثات الواجهة الخلفية واجهتك ذات العلامة التجارية؛ ثبّت حزمة سطح مكتب My King التالية بعد التحقق منها للحصول على ميزات الواجهة الجديدة.',
      bundleOutOfSyncAction: 'فتح تحديثات My King',
      updates: 'التحديثات',
      checkNow: 'التحقق الآن',
      checking: 'جار التحقق...',
      seeWhatsNew: 'عرض الجديد',
      updateNow: 'تحديث الآن',
      releaseNotes: 'تفاصيل التحديث',
      ...
      automaticUpdatesDesc:
        'يحدّث My King الواجهة الخلفية بشكل مستقل، وتبقى الواجهة ذات العلامة التجارية والتخطيط دون تغيير حتى تثبيت حزمة My King مكتبية تم التحقق منها.',
      ...
      uninstall: {
        ...
        checking: 'جار التحقق من المكونات المثبتة…',
        confirmTitle: 'تأكيد إلغاء التثبيت',
        confirmDescription: consequence => `سيؤدي هذا إلى إزالة ${consequence}. لا يمكن التراجع عن ذلك.`,
        appPath: path => `التطبيق: ${path}`,
        failedStart: 'تعذر بدء إلغاء التثبيت.',
        uninstalling: 'جار إلغاء التثبيت…',
        confirmAction: 'نعم، ألغ التثبيت',
        cancel: 'إلغاء',
        title: 'إلغاء تثبيت My King',
        description: 'اختر مقدار ما تريد إزالته. سيغلق التطبيق لإكمال العملية ويمكنك إعادة تثبيته لاحقا.',
        options: {
          gui: {
            title: 'إزالة تطبيق سطح المكتب فقط',
            description: 'يبقى وكيل My King والإعدادات والمحادثات.',
            consequence: 'تطبيق سطح المكتب وبياناته المحلية'
          },
          lite: {
            title: 'إزالة التطبيق والوكيل مع إبقاء البيانات',
            description: 'تبقى الإعدادات والمحادثات والأسرار لإعادة التثبيت مستقبلا.',
            consequence: 'تطبيق سطح المكتب ووكيل My King مع إبقاء الإعدادات والمحادثات والأسرار'
          },
          full: {
            title: 'إزالة كل شيء',
            description: 'إزالة التطبيق والوكيل وكل بيانات My King.',
            consequence: 'التطبيق ووكيل My King والإعدادات والمحادثات والأسرار والسجلات'
          }
        }
      }
    },
    config: {
      ...
      loading: 'جار تحميل إعدادات My King...',
    ...
    quickEntry: {
      ...
      enabledDesc: 'استدعِ محرّرا صغيرا من أي مكان باختصار عام وأرسل طلبا دون فتح My King.',
    ...
    gateway: {
      ...
      restartingMessage: 'سيعيد My King Desktop الاتصال باستخدام الإعدادات المحفوظة.',
      savedMessage: 'تم الحفظ للتشغيل القادم.',
      connectedTo: (baseUrl, version) => `متصل بـ ${baseUrl}${version ? ` · My King ${version}` : ''}`,
    ...
    mcp: {
      ...
      deepLinkDescription:
        'طلب رابط إضافة خادم MCP هذا إلى My King. راجع الإعدادات الكاملة أدناه — فهي قادمة من الرابط وليست من My King.',
    ...
    providers: {
      ...
      intro: 'سجل الدخول باشتراكك دون نسخ مفتاح API. يشغّل My King تسجيل الدخول من المتصفح لك داخل التطبيق.',
      connected: 'متصل',
      collapse: 'طي',
      ...
      providerDescriptions: {
        nousPortal: 'نماذج مستضافة من My King ومدرّبة بواسطة Nous',
        fireworks: 'واجهة API مباشرة متوافقة مع OpenAI',
        openrouter: 'مجمّع لمئات النماذج المتقدمة',
        anthropic: 'الوصول إلى Claude API (Sonnet وOpus وHaiku)',
        xai: 'نماذج Grok (استخدم OAuth لـ SuperGrok / Premium+)',
        gemini: 'Google AI Studio (Gemini 1.5 / 2.0 / 2.5)',
        deepseek: 'وصول مباشر إلى DeepSeek API (V3.x وR1)',
        dashscope: 'Alibaba Cloud DashScope — نماذج Qwen ونماذج من مزودين متعددين',
        glm: 'نقاط نهاية Zhipu GLM-4.6 وZ.AI المستضافة',
        kimi: 'نقاط نهاية Moonshot Kimi K2 / البرمجية',
        kimiChina: 'نقطة نهاية Moonshot في الصين',
        minimax: 'نقاط نهاية MiniMax-M2 وHailuo الدولية',
        minimaxChina: 'نقطة نهاية MiniMax في البر الرئيسي للصين',
        huggingFace: 'Inference Providers — أكثر من 20 نموذجًا مفتوحًا عبر router.huggingface.co',
        openCodeZen: 'وصول بالدفع حسب الاستخدام إلى نماذج برمجة منتقاة',
        openCodeGo: 'اشتراك بقيمة 10 دولارات شهريًا لنماذج البرمجة المفتوحة',
        nvidia: 'build.nvidia.com أو نقطة نهاية NIM محلية تستضيفها بنفسك',
        ollama: 'نماذج مفتوحة مستضافة سحابيًا من ollama.com',
        lmStudio: 'خادم LM Studio محلي (متوافق مع OpenAI)',
        stepFun: 'نماذج البرمجة من StepFun Step Plan',
        xiaomiMiMo: 'نماذج MiMo-V2.5 ونماذج Xiaomi الخاصة',
        arceeAi: 'نماذج صغيرة ومتوسطة مستضافة من Arcee',
        gmiCloud: 'وحدات GPU وخدمة نماذج GMI Cloud',
        azureFoundry: 'نقاط نهاية مخصصة لـ Azure AI Foundry (متوافقة مع OpenAI / Anthropic)',
        awsBedrock: 'المصادقة عبر ملف تعريف AWS والمنطقة'
      },
      localEndpoint: {
      ...
      customEndpoints: {
        ...
        auto: 'تلقائي',
        apiKey: 'مفتاح API',
        keepCurrentKey: 'اتركه فارغاً للاحتفاظ بالمفتاح الحالي',
        optional: 'اختياري',
        ...
        loadFailed: 'تعذر تحميل نقاط النهاية المخصصة',
        saved: 'تم حفظ نقطة النهاية المخصصة.',
        saveFailed: 'فشل الحفظ',
        reachableWithModels: count => `يمكن الوصول إلى نقطة النهاية. تم العثور على ${count} نموذج.`,
        reachable: 'يمكن الوصول إلى نقطة النهاية.',
        validationFailed: 'فشل التحقق من نقطة النهاية.',
        activationFailed: 'فشل التنشيط',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'أعد تشغيل My King لاستخدام الحيوانات الأليفة — الخادم الخلفي أقدم من هذه الميزة.',
    ...
    generatePet: {
      ...
      staleBackend: 'حدّث My King لتوليد الحيوانات الأليفة.',
      backgroundHint: 'يمكنك إغلاق هذا — سيُعلِمك My King عند الانتهاء.',
    ...
    hermesActiveSessions: (version, count) => `My King ${version} لديه ${count} جلسة نشطة`,
  ...
  messaging: {
    search: 'بحث',
    platformSummary: name => `استخدم My King عبر ${name}.`,
    loading: 'جار التحميل...',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'لم يحفظ My King تغيير النموذج هذا.'
    },
    search: 'بحث',
    loading: 'جار التحميل...',
    states: {
    ...
    emptyDescNew: 'أنشئ مهمة مجدولة لتشغيل My King تلقائيا.',
    ...
    createDesc: 'اضبط مهمة يشغلها My King تلقائيا.',
    nameLabel: 'الاسم',
    namePlaceholder: 'مثال: الملخص الصباحي',
    promptLabel: 'الرسالة',
    promptPlaceholder: 'ماذا تريد من My King أن يفعل؟',
  ...
  sidebar: {
    ...
    projects: {
      ...
      deleteConfirm: 'هذا يزيل المشروع المحفوظ من My King. تبقى الملفات ومستودعات git وأشجار العمل دون تغيير.',
      ...
      worktreeStaleBackend:
        'حدِّث خادم My King لإنشاء أشجار العمل عبر هذا الاتصال البعيد — فهو أقدم من واجهة git worktree.',
  ...
  composer: {
    intro: {
      headline: 'مساحة عملك، تبدأ بطلب واحد.',
      body: 'ابحث في المشروع وعدّل الملفات وشغّل الاختبارات وادفع العمل إلى الأمام. حدّد الهدف ودع My King يتولى الباقي.'
    },
    message: 'الرسالة',
    wakingProfile: profile => `جار إيقاظ ${profile}`,
    placeholderStarting: 'جار بدء My King...',
    placeholderReconnecting: 'جار إعادة الاتصال...',
    placeholderFollowUp: 'اكتب متابعة...',
    newSessionPlaceholders: ['اسأل My King عن شيء...', 'اطلب من My King تنفيذ مهمة...', 'ابدأ محادثة جديدة...'],
    ...
    wakeWordListening: () => 'كلمة التنبيه — قيد الاستماع',
    wakeWordOff: () => 'كلمة التنبيه — متوقفة',
    wakeWordPausedVoice: () => 'كلمة التنبيه — متوقفة مؤقتًا أثناء المحادثة الصوتية',
    ...
    urlHintPre: 'سيقرأ My King الرابط ضمن السياق.',
    attach: 'إرفاق',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'اطلب من My King فتح PR',
  ...
  updates: {
    stages: {
      ...
      pydeps: 'جار الإنهاء...',
      update: 'جار تحديث My King...',
      rebuild: 'جار إعادة بناء تطبيق سطح المكتب...',
      restart: 'جار إعادة تشغيل My King...',
      done: 'اكتمل التحديث',
    ...
    unsupportedMessage: 'لا يمكن لهذا الإصدار من My King تحديث نفسه من داخل التطبيق.',
    ...
    availableBody: 'إصدار جديد من My King جاهز للتثبيت.',
    availableTitleBackend: 'يتوفر تحديث للواجهة الخلفية',
    availableBodyBackend: 'إصدار أحدث من واجهة My King الخلفية المتصلة جاهز للتثبيت.',
    ...
    applyingBody:
      'يتولّى مُحدِّث My King المهمة في نافذته الخاصة ويعيد فتح My King تلقائيا عند الانتهاء. الرجاء عدم إعادة فتح My King بنفسك أثناء التحديث.',
    applyingBodyBackend:
      'تطبّق الواجهة الخلفية البعيدة التحديث وستعيد التشغيل. يعيد My King الاتصال تلقائيا عند عودتها.',
    applyingClose: 'ستُغلق هذه النافذة أثناء تشغيل التحديث، ثم يعيد My King فتح نفسه تلقائيا.',
    errorTitle: 'لم يكتمل التحديث',
    errorBody: 'لا داعي للقلق — لم يُفقد شيء. يمكنك إعادة المحاولة الآن.',
    blockerTitle: 'إغلاق المعاينات المحلية لتحديث My King؟',
    blockerBody: 'يحتاج My King إلى إيقاف هذه المعاينات المحلية قبل التحديث. لن يؤدي ذلك إلى تعديل ملفاتك أو حذفها.',
    foreignBlockerTitle: 'أغلق العمليات الأخرى لتحديث My King',
    foreignBlockerBody:
      'لا يمكن لـ My King إغلاق هذه العمليات تلقائيًا بأمان. أغلق التطبيق أو الطرفية أو الخدمة التي تشغّل كل عملية، ثم حاول التحديث مرة أخرى.',
    mixedBlockerBody:
      'يمكن لـ My King إغلاق المعاينات المحلية المدرجة أدناه. يجب إغلاق العمليات الأخرى يدويًا قبل متابعة التحديث.',
  ...
  install: {
    ...
    oneTimeTitle: 'يحتاج My King إلى تثبيت لمرة واحدة',
    ...
    settingUpTitle: 'جار إعداد وكيل My King',
    finishingTitle: 'جار الإنهاء',
    failedDesc:
      'فشلت إحدى خطوات التثبيت. على Windows، قد يحدث هذا إذا كان هناك نسخة أخرى من My King CLI أو تطبيق سطح المكتب قيد التشغيل. أوقف أي نسخ My King قيد التشغيل، ثم أعد المحاولة. تحقق من التفاصيل أدناه أو من سجل سطح المكتب للحصول على النص الكامل.',
    activeDesc:
      'هذا إعداد لمرة واحدة. يقوم مثبّت My King بتنزيل التبعيات وتهيئة جهازك. ستتخطى عمليات التشغيل اللاحقة هذه الخطوة.',
  ...
  onboarding: {
    headerTitle: 'لنُعِدّ لك My King Agent',
    headerDesc: 'اربط مزوّد نماذج لبدء المحادثة. معظم الخيارات تتطلب نقرة واحدة.',
    preparingInstall: 'يُكمل My King التثبيت. عادة ما يستغرق ذلك أقل من دقيقة في أول تشغيل.',
    starting: 'جار بدء My King...',
    ...
    recommended: 'موصى به',
    connected: 'متصل',
    featuredPitch: 'اشتراك واحد، أكثر من 300 نموذج متقدم — الطريقة الموصى بها لتشغيل My King',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'مستضاف ذاتيا',
        description:
          'وجّه My King إلى نقطة نهاية محلية أو مستضافة ذاتيا متوافقة مع OpenAI (vLLM، llama.cpp، Ollama، إلخ).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'يفتح صفحة تحقق في المتصفح — يتصل My King تلقائياً',
      loopback: 'يفتح المتصفح لتسجيل الدخول — يتصل My King تلقائياً',
    ...
    authorizeThere: 'صرّح لـ My King هناك.',
    copyAuthCode: 'انسخ رمز التفويض وألصقه أدناه.',
    pasteAuthCode: 'ألصق رمز التفويض',
    reopenAuthPage: 'إعادة فتح صفحة التفويض',
    autoBrowser: provider =>
      `فتحنا ${provider} في المتصفح. صرّح لـ My King هناك وسيتم الاتصال تلقائياً دون نسخ أو لصق.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      gateway: 'البوابة',
      gatewayConnected: 'متصلة',
      gatewayReady: 'جاهزة',
      gatewayNeedsSetup: 'تحتاج إعدادا',
      gatewayChecking: 'جار فحص البوابة',
      gatewayConnecting: 'جار الاتصال',
  ...
  preview: {
    ...
    largeBody: (label, size) => `حجم ${label} هو ${size}. سيعرض My King أول 512 KB فقط.`,
    ...
    web: {
      ...
      tryAgain: 'إعادة المحاولة',
      restarting: 'جار إعادة تشغيل My King...',
      askRestart: 'اطلب من My King إعادة تشغيل الخادم',
      lookingRestart: taskId => `يبحث My King عن خادم معاينة لإعادة تشغيله (${taskId})`,
      restartingTitle: 'جار إعادة تشغيل خادم المعاينة',
      restartingMessage: 'يعمل My King في الخلفية. راقب كونسول المعاينة لمتابعة التقدم.',
      ...
      blankPageBody: 'اكتب عنوانًا في الأعلى للتصفح، أو اطلب من My King فتح صفحة.',
      finishedRestarting: message => `أنهى My King إعادة تشغيل خادم المعاينة${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'تعذّر على My King إعادة تشغيل الخادم.',
      stillWorking:
        'لا يزال My King يعمل، لكن لم تصل نتيجة إعادة التشغيل بعد. قد يكون أمر الخادم قيد التشغيل في المقدمة.',
  ...
  desktop: {
    ...
    fileStillSaving: 'لا يزال الملف قيد الكتابة. انتظر حتى يكتمل الحفظ، ثم أعد المحاولة.',
