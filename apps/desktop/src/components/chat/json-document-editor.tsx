...
export function JsonDocumentEditor({
  ...
  return (
    <div
      ...
      data-slot="json-document-editor"
    >
      <div className="flex h-8 shrink-0 items-center gap-2 px-3" data-slot="json-document-editor-header">
        {header ? (
      ...
      <div className="min-h-0 flex-1" data-slot="json-document-editor-body">
        <CodeEditor
          apiRef={editorApi}
          disabled={disabled}
          filePath={filePath}
