...
// My King Cloud discovery lifecycle for the cloud-mode panel.
...
export function GatewaySettings({ embedded = false }: { embedded?: boolean } = {}) {
  ...
  // --- My King Cloud (cloud mode) state ---
  ...
  return (
    <SettingsContent bare={embedded}>
      ...
      {/* My King Cloud panel: one portal sign-in, then a discovered-agent picker
