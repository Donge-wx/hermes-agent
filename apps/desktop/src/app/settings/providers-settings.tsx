...
function ConnectedProviderRow({
  ...
  // My King can clear this provider's creds via the API.
  const canDisconnect = provider.disconnectable ?? provider.flow !== 'external'
  // External (CLI-managed) provider My King can't clear via the API, but ships a
...
export function ProvidersSettings({
  ...
  // My King never deletes creds another tool owns behind a silent API call.
