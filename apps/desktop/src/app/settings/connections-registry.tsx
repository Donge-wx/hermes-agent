...
import { Cloud, Globe, Loader2, Monitor, Pencil, Plus, SearchIcon, Terminal, Trash2 } from '@/lib/icons'
 ...
 * agent sources (local runtime + any number of remote gateways / My King Cloud
            ...
            <ListRow
              ...
              title={
                <span className="flex items-center gap-2">
                  ...
                  <span className="truncate">{conn.kind === 'local' ? kindMeta.local.label : conn.label}</span>
