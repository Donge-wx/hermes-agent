...
declare global {
  interface Window {
    hermesDesktop: {
      ...
      // My King Cloud: one portal login powers discovery + silent per-agent
...
export interface DesktopConnectionConfig {
  envOverride: boolean
  // The saved connection mode. 'cloud' is a My King Cloud connection: it carries
  ...
  remoteUrl: string
  // For a 'cloud' connection: the persisted My King Cloud org (slug or id) the
...
export interface DesktopConnectionConfigInput {
  ...
  remoteUrl?: string
  // For a 'cloud' connection: the selected My King Cloud org (slug or id) to
...
// A discovered My King Cloud agent — the trimmed DTO from NAS GET /api/agents.
