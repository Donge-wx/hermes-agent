...
export class HermesGateway extends JsonRpcGatewayClient {
  constructor() {
    super({
      closedErrorMessage: 'My King gateway connection closed',
      connectErrorMessage: 'Could not connect to My King gateway',
      createRequestId: nextId => nextId,
      notConnectedErrorMessage: 'My King gateway is not connected',
