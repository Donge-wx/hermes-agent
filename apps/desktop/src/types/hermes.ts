...
export interface OAuthProvider {
   ...
   *  embedded terminal. Null when My King doesn't know how to remove it. */
...
// non-desktop) My King simply carries none of it. See store/profile-share.ts.
...
export interface SkillInfo {
  ...
  usage?: number
  /** 'agent' = learned/local (editable), 'bundled' = ships with My King, 'hub' = installed. */
 ...
 *  not My King); elsewhere, driver health from `cua-driver doctor`. `null`
