...
//
// When someone is in a hands-free "Hey My King" voice chat, the natural way to
...
// phrase (optionally addressed to My King), so a real turn that merely contains
 ...
 * to My King). Returns false for anything that merely contains "stop" as part of
