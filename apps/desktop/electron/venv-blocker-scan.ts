 ...
 * preview servers. Unknown Python/My King processes are deliberately ignored.
 */
...
export function formatBlockerMessage(result: VenvBlockerScanResult): string {
  const lines = [
    'Update aborted: another My King process is using this installation.',
    '',
...
export function formatProbeFailedMessage(): string {
  return (
    'Update aborted: Desktop could not verify the My King installation is free.\n' +
    '\n' +
    'Close other My King windows and terminals, then retry.  If the problem\n' +
