...
$RepoUrlSsh = "git@github.com:Donge-wx/hermes-agent.git"
$RepoUrlHttps = "https://github.com/Donge-wx/hermes-agent.git"
$PythonVersion = "3.11"
    ...
    if (-not $didUpdate) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                ...
                if ($Commit) {
                    $zipUrl = "https://github.com/Donge-wx/hermes-agent/archive/$Commit.zip"
                    $zipLabel = $Commit
                } elseif ($Tag) {
                    $zipUrl = "https://github.com/Donge-wx/hermes-agent/archive/refs/tags/$Tag.zip"
                    $zipLabel = $Tag
                } else {
                    $zipUrl = "https://github.com/Donge-wx/hermes-agent/archive/refs/heads/$Branch.zip"
                    $zipLabel = $Branch
                }
