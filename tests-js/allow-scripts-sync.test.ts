 ...
 * ``stage-native-deps``. In the same window, a CVE sweep moved Electron
 * without updating its versioned allow entry, blocking Electron's own
 * postinstall on any clean install.
 *
